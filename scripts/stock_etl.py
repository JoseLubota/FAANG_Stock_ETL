...
def get_spark_session():
    ...
    return spark
#====================================================================================================================================#
# Function: Fetch Stock (Meta, Amazon, Netflix, Apple, Google) Data from yfinance 
#====================================================================================================================================#
def fetch_stock_data(ticker, period='20y'):
    ...
    try:
        ...
        # Raise error if yfinance does not return any value.
        if df.empty:
            raise ValueError(f"No data found for ticker {ticker}")
        
        # Reset dataframe indexes to correct the columns settings
        ...
        raise
#====================================================================================================================================#
# Function: Transform data using PySpark
#====================================================================================================================================#
def transform_data(spark, df):
    ...
    return sdf
#====================================================================================================================================#
# Function: Load the transformed data into my local PostgreSQL database
#====================================================================================================================================#
def load_to_postgres(sdf, jdbc_url, user, password, table_name='stock_etl'):
    ...
    # Save data to stock_etl table, If table exists, appends data
    try: 
        sdf.write.jdbc(
        url=jdbc_url,
        table=table_name,
...
def run_stock_etl(ticker, period, jdbc_url, user, password, **context):
    ...
    try:
        ...
        # Returns a summary for Airflow's XCom
        return {
            'ticker': ticker,
        ...
        # Terminates the pyspark session.
        if 'spark' in locals():
            spark.stop()
